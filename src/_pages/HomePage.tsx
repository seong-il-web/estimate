    ...
    <main className="w-full bg-gray-50">
      ...
      <section className="py-12 sm:py-16 bg-gray-100">
        <div className="container mx-auto text-center px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 sm:mb-12 text-gray-800">접수 가능 파일</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
              ...
              <p className="text-lg sm:text-xl text-cyan-700 mb-4 sm:mb-6">PDF로 저장시 글씨는 레지스터화 해주세요</p>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-8">
              <div className="text-center">
                <div className="w-40 h-40 sm:w-48 sm:h-48 relative mb-4">
                  <Image src={img05} alt="img_05" layout="fill" objectFit="contain" className="rounded-lg shadow-lg" />
                </div>
              ...
              <div className="text-center">
                <div className="w-40 h-40 sm:w-48 sm:h-48 relative mb-4">
                  <Image src={img04} alt="img_04" layout="fill" objectFit="contain" className="rounded-lg shadow-lg" />
                </div>
          ...
          <div className="w-full max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-xl">
                ...
                <div className="w-full relative" style={{ paddingBottom: "75%" }}>
                  <Image src={img03} alt="img_03" layout="fill" objectFit="contain" className="rounded-lg" />
                </div>
              </div>
              <div className="bg-gray-50 p-4 sm:p-6 rounded-lg shadow-xl">
            ...
            <div className="mt-8 sm:mt-12 text-center bg-gray-100 p-4 sm:p-6 rounded-lg shadow-lg">
              <p className="text-base sm:text-lg md:text-xl mb-2 text-gray-800 mb-[0px]">
      ...
      <section id="outline" className="py-12 sm:py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center bg-white p-4 sm:p-6 rounded-lg shadow-lg">
            <p className="text-lg sm:text-xl md:text-2xl text-gray-800 mb-2">문자 -&gt; 윤곽선 만들기</p>
      ...
      <section id="guidelines" className="py-12 sm:py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-8 sm:mb-12 text-center text-gray-800">
            안내사항
          </h2>
